...
async function fetchServerDataInitial() {
    try {
        ...
        console.log("العمل بالوضع المحلي الفردي");
    }
}
...
const translations = {
    ar: {
        ...
        txtRevChartTitle: "إحصائيات الإيرادات الحالية",
        txtCasesChartTitle: "توزيع الحالات المرضية بالعيادة",
        txtBtnRecSub: "الاستقبال والترياج",
        txtBtnExamSub: "غرفة الفحص",
        txtBtnInvSub: "إصدار فاتورة جديدة",
        recTitle: "مكتب الاستقبال وتسجيل العلامات الحيوية",
        txtRecDesc: "البحث برقم بطاقة التعريف، الفلترة التلقائية، وقياس العلامات الحيوية",
        lblIdCard: "رقم بطاقة التعريف الوطنية (ID Card)",
        lblSelPatient: "اسم المريض الكامل",
        lblPhoneNum: "رقم الهاتف",
        lblAssignDoc: "الطبيب المعالج",
        lblWeight: "الوزن (kg)",
        lblTension: "ضغط الدم",
        lblSugar: "نسبة السكري (g/L)",
        txtEmergencyLabel: "حالة طارئة / أولوية مستعجلة",
        btnSubmitTriage: "تسجيل وإرسال المريض لقائمة انتظار الفحص",
        lblQueueTitle: "قائمة انتظار المرضى عند الطبيب",
        thQueueNum: "الدور",
        thQueuePat: "المريض",
        thQueueIdCard: "رقم البطاقة (ID)",
        thQueueVisitType: "صفة الزيارة",
        thQueueDoc: "الطبيب",
        ...
        txtVitalsRiskTitle: "تحليل المؤشرات الحيوية",
        txtCumulativeChartTitle: "الملف الصحي التراكمي (الأشعة والتحاليل السابقة للمريض)",
        txtCumulativeChartSub: "يعرض كافة الفحوصات والتقارير الطبية للمريض",
        ...
        lblDuration: "مدة العلاج",
        btnAddDrugRow: "إضافة دواء للجدول",
        btnSavePrescFull: "حفظ وصرف الوصفة كاملة",
        thDrug: "الدواء",
        thDoses: "الجرعات",
        thTime: "الوقت",
        thDuration: "المدة",
        thAction: "إجراء",
        txtNoDrugsAdded: "لم يتم إضافة أدوية للوصفة بعد",
        ...
        thDocShift: "الدوام",
        thDocPhone: "الهاتف",
        thDocAction: "الإجراءات",
        invTabTitle: "الفواتير والتحصيل",
        btnNewInv: "إصدار فاتورة",
        thInvNum: "رقم الفاتورة",
        thInvPat: "المريض",
        thInvServ: "الخدمة",
        thInvAmount: "المبلغ",
        thInvPay: "الدفع",
        thInvAction: "الإجراءات",
        reportsTabTitle: "التقارير وسجل النشاط والتدقيق الأمني (Audit Log)",
        reportsSubTitle: "سجل عمليات النظام والحذف والتعديل للموظفين",
        thLogUser: "المستخدم",
        thLogAction: "الإجراء المنفذ",
        thLogTime: "التاريخ والوقت",
        settingsTabTitle: "إعدادات النظام والعيادة الشاملة",
        settingsSubTitle: "تخصيص الهوية، التسعير، الضرائب، ساعات العمل، وإدارة النسخ الاحتياطية",
        btnSaveSettings: "حفظ جميع التعديلات",
        stgSec1Title: "الملف التعريفي وهوية العيادة",
        lblStgName: "اسم العيادة الرسمي",
        lblStgSpec: "التخصص العام للمركز",
        lblStgPhone: "هاتف التواصل الرسمي",
        lblStgAddr: "العنوان والشارع",
        stgSec2Title: "التسعير والرسوم والضرائب",
        lblStgFee: "كشفية الزيارة الافتراضية",
        lblStgTax: "نسبة ضريبة القيمة المضافة (%)",
        lblStgCurr: "العملة المعتمدة في النظام",
        stgSec3Title: "أوقات العمل والتنبيهات الذكية",
        lblStgHours: "ساعات الدوام اليومي للعيادة",
        lblStgPrint: "حجم ورق الطباعة الافتراضي",
        lblStgAlerts: "التنبيهات الصوتية للحالات الطارئة",
        stgSec4Title: "أمن البيانات والنسخ الاحتياطي",
        btnExportBackup: "تصدير نسخة احتياطية كاملة (JSON)",
        lblImportBackup: "استرجاع نسخة احتياطية من ملف",
        btnResetData: "تصفير ومسح معطيات العيادة",
        titlePermissions: "صلاحيات المستخدمين وإدارة الحسابات وكلمات المرور",
        txtStaffSub: "تعديل حسابات الموظفين، تغيير كلمات المرور، وتحديد صلاحيات الواجهات",
        btnNewStaff: "إنشاء حساب موظف جديد",
        txtStaffTableTitle: "قائمة حسابات الموظفين والمستخدمين",
        thStaffName: "اسم الموظف",
        thStaffUser: "اسم المستخدم",
        thStaffPass: "كلمة المرور",
        thStaffRole: "الدور الوظيفي",
        thStaffAction: "الإجراءات",
    ...
    fr: {
        ...
        lblCardRev: "Revenus",
        lblCardSatisfaction: "Satisfaction Patients",
        txtRevChartTitle: "Statistiques des Revenus Actuels",
        txtCasesChartTitle: "Répartition des Cas Cliniques",
        txtBtnRecSub: "Accueil & Triage",
        txtBtnExamSub: "Salle d'Examen",
        txtBtnInvSub: "Émettre une Facture",
        recTitle: "Bureau d'Accueil et Enregistrement Vital",
        txtRecDesc: "Recherche par ID, filtrage automatique et signes vitaux",
        lblIdCard: "Numéro de Carte d'Identité (ID)",
        lblSelPatient: "Nom Complet du Patient",
        lblPhoneNum: "Numéro de Téléphone",
        lblAssignDoc: "Médecin Traitant",
        lblWeight: "Poids (kg)",
        lblTension: "Tension Artérielle",
        lblSugar: "Taux de Glycémie (g/L)",
        txtEmergencyLabel: "Cas d'Urgence / Priorité Haute",
        btnSubmitTriage: "Enregistrer et envoyer en file d'attente",
        lblQueueTitle: "File d'attente des patients chez le médecin",
        thQueueNum: "Rôle",
        thQueuePat: "Patient",
        thQueueIdCard: "Carte ID",
        thQueueVisitType: "Type de Visite",
        thQueueDoc: "Médecin",
        thQueueVitals: "Signes Vitaux",
        thQueuePriority: "Priorité",
        thQueueAction: "Action",
        examTitle: "Salle d'Examen Clinique et Ordonnances",
        txtExamDesc: "Enregistrement du diagnostic, procédures et prescription",
        txtSelFromQueue: "Sélectionner de la file:",
        optSelPatientPrompt: "-- Choisir un patient à examiner --",
        txtVitalsRiskTitle: "Analyse des Signes Vitaux",
        txtCumulativeChartTitle: "Dossier de Santé Cumulé (Imagerie & Analyses)",
        txtCumulativeChartSub: "Affiche tous les examens et rapports du patient",
        ...
        lblDuration: "Durée du Traitement",
        btnAddDrugRow: "Ajouter le médicament",
        btnSavePrescFull: "Enregistrer et Délivrer l'Ordonnance",
        thDrug: "Médicament",
        thDoses: "Doses",
        thTime: "Moment",
        thDuration: "Durée",
        thAction: "Action",
        txtNoDrugsAdded: "Aucun médicament ajouté pour le moment",
        ...
        txtExamCardSugar: "Glycémie",
        apptsTabTitle: "Gestion du Calendrier des Rendez-vous",
        btnNewAppt: "Nouveau Rendez-vous",
        thApptPat: "Patient",
        thApptDoc: "Médecin",
        thApptDate: "Date",
        thApptStatus: "Statut",
        ...
        thPatDob: "Date Naissance",
        thPatPhone: "Téléphone",
        thPatStatus: "Statut",
        ...
        thDocShift: "Permanence",
        thDocPhone: "Téléphone",
        thDocAction: "Actions",
        invTabTitle: "Facturation et Recouvrement",
        btnNewInv: "Émettre Facture",
        thInvNum: "N° Facture",
        thInvPat: "Patient",
        thInvServ: "Service",
        thInvAmount: "Montant",
        thInvPay: "Paiement",
        thInvAction: "Actions",
        reportsTabTitle: "Rapports, Journal d'Activité et Audit de Sécurité",
        reportsSubTitle: "Registre des opérations, suppressions et modifications",
        thLogUser: "Utilisateur",
        thLogAction: "Action Exécutée",
        thLogTime: "Date et Heure",
        settingsTabTitle: "Paramètres Globaux du Système et de la Clinique",
        settingsSubTitle: "Personnalisation, tarification, taxes, horaires et sauvegardes",
        btnSaveSettings: "Enregistrer toutes les modifications",
        stgSec1Title: "Profil et Identité de la Clinique",
        lblStgName: "Nom Officiel de la Clinique",
        lblStgSpec: "Spécialité Générale du Centre",
        lblStgPhone: "Téléphone de Contact Officiel",
        lblStgAddr: "Adresse et Rue",
        stgSec2Title: "Tarification, Frais et Taxes",
        lblStgFee: "Frais de Consultation par Défaut",
        lblStgTax: "Taux de TVA (%)",
        lblStgCurr: "Devise Adoptée dans le Système",
        stgSec3Title: "Horaires de Travail & Alertes Intelligentes",
        lblStgHours: "Heures de Travail Quotidiennes",
        lblStgPrint: "Format d'Impression par Défaut",
        lblStgAlerts: "Alertes Sonores pour Cas d'Urgence",
        stgSec4Title: "Sécurité des Données & Sauvegarde",
        btnExportBackup: "Exporter une Sauvegarde Complète (JSON)",
        lblImportBackup: "Restaurer une Sauvegarde à partir d'un Fichier",
        btnResetData: "Réinitialiser et Effacer les Données",
        titlePermissions: "Permissions des Utilisateurs, Gestion des Comptes & Mots de Passe",
        txtStaffSub: "Modification des comptes, mots de passe et accès aux interfaces",
        btnNewStaff: "Créer un Nouveau Compte Employé",
        txtStaffTableTitle: "Liste des Comptes et Utilisateurs",
        thStaffName: "Nom de l'Employé",
        thStaffUser: "Nom d'Utilisateur",
        thStaffPass: "Mot de Passe",
        thStaffRole: "Rôle Fonctionnel",
        thStaffAction: "Actions",
        optSelDocDefault: "-- Choisir le médecin traitant --",
